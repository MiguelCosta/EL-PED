                    ...
                    <div id="containt_main_users">
                        ...
                        if (!$con) {
                            ...
                            <div id="page">
                                ...
                                $link_menos = "gerirU_Listar.php?page_a=$page_menos&page_p=$page_p&page_c=$page_c";
                                $link_mais = "gerirU_Listar.php?page_a=$page_mais&page_p=$page_p&page_c=$page_c";
                                ?>
                                <?php
                                if ($page_a > 1) {
                                    ?>
                            ...
                            <div id="page">
                                ...
                                $link_menos = "gerirU_Listar.php?page_a=$page_a&page_p=$page_menos&page_c=$page_c";
                                $link_mais = "gerirU_Listar.php?page_a=$page_a&page_p=$page_mais&page_c=$page_c";
                                ?>
                                <?php
                                if ($page_p > 1) {
                                    ?>
                            ...
                            <div id="page">
                                ...
                                $link_menos = "gerirU_Listar.php?page_a=$page_a&page_p=$page_p&page_c=$page_menos";
                                $link_mais = "gerirU_Listar.php?page_a=$page_a&page_p=$page_p&page_c=$page_mais";
                                ?>
                                <?php
                                if ($page_c > 1) {
                                    ?>
