                ...
                <div id="content_main">
                    ...
                    <div id="containt_main_users">
                        ...
                        if (!$con) {
                            ...
                            /* _________________________ Não podem ser alterados _________________________ */
                            
                            $max = $page_a * $num_sup;
                            $min = $max - $num_sup;
                            $username = $_SESSION['username'];
                            $sql = "SELECT username, name, email,affil,url FROM Users WHERE type='a' AND username='$username' ORDER BY name LIMIT $min , $num_sup";
                            ...
                            <div id="page">
                                ...
                                $link_menos = "gerirU_Remover.php?page_a=$page_menos&page_p=$page_p&page_c=$page_c";
                                $link_mais = "gerirU_Remover.php?page_a=$page_mais&page_p=$page_p&page_c=$page_c";
                                ?>
                                <?php
                                if ($page_a > 1) {
                                    ?>
                            ...
                            <div id="page">
                                ...
                                $link_menos = "gerirU_Remover.php?page_a=$page_a&page_p=$page_menos&page_c=$page_c";
                                $link_mais = "gerirU_Remover.php?page_a=$page_a&page_p=$page_mais&page_c=$page_c";
                                ?>
                                <?php
                                if ($page_p > 1) {
                                    ?>
                            ...
                            <div id="page">
                                ...
                                $link_menos = "gerirU_Remover.php?page_a=$page_a&page_p=$page_p&page_c=$page_menos";
                                $link_mais = "gerirU_Remover.php?page_a=$page_a&page_p=$page_p&page_c=$page_mais";
                                ?>
                                <?php
                                if ($page_c > 1) {
                                    ?>
