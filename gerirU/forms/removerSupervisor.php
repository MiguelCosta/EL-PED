...
<div id="formInsertAS">
    ...
    <div id="formInsertAS_Supervisor">
        <form id="formSupervisor" name="inserirSupervisor" method="post" action="gerirAS_Remover_respSupervisor.php">
            ...
            <div id="s_btn_submit" style="width: 180px;">
                <input type="submit" 
                       value="Remover Supervisor"/>
            </div>
